    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <p class="mt-2 text-center text-sm text-gray-600">
        ...
        <NuxtLink to="/register-tenant" class="font-medium text-blue-600 hover:text-blue-500">
          join to One E-commerce as tenant
        </NuxtLink>
      </p>
    </div>
          ...
          <div>
            ...
            <div class="mt-1">
              <input
                ...
                autocomplete="name"
                required
                class="appearance-none block w-full px-3 py-2 border text-gray-700 border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
